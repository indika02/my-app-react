...
import { styled, ListItemText, ListItemIcon, ListItem, Divider, Drawer, List, alpha, AppBar, Box, Toolbar, IconButton, Typography, InputBase, Badge, MenuItem, Menu, useTheme } from '@mui/material';
...
import userAcc from "../../UserAccount/UserAcc"
/*Main app bar */
...
export default function Header() {
    ...
    const menuBottonHandle = e => console.log(e.target.value);
                        ...
                        <ListItem button key={text} component={Link} to={{                                                                           /*Display Sidebar menu icon using switch case */
                            ...
                            <ListItemIcon>
                                {{                                                                           /*Display Sidebar menu icon using switch case */
                                    'Home': <HomeIcon />,
                                    'Become a driver': <DriveEtaIcon />,
                                    'My booking': <MenuBookIcon />,
                                    'Today routings': <RouteIcon />
                                }[text]}
                            </ListItemIcon>
